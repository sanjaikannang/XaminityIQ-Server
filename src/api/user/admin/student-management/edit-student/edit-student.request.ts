...
import {
    Gender, RelationType, EducationLevel, Qualification, BoardType, Country
} from 'src/utils/enum';
import {
    IsString, IsEmail, IsEnum, IsDateString, IsBoolean, IsOptional, IsNumber, ValidateNested,
    IsNotEmpty, Matches, MaxLength, ArrayMinSize
...
export class EditStudentRequest {
    ...
    // Contact Information (studentEmail is never editable)
    @IsEmail()
